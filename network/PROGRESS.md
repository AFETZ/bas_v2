...
- The exact ordered M0 suite contains **178 unique test IDs** and is bound by
...
python3 -m unittest discover -b -s network/tests -p 'test_*.py'
  -> 178/178 passed across the complete focused preflight set
...
2. Commit one clean technical base containing the 178-ID manifest.
