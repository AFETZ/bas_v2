...
COMMAND_OUTCOME_TIMEOUT_NS = 3 * NS_PER_SECOND
MAX_STAGE_EXECUTION_NS = (
    MAX_COMMAND_ATTEMPTS * COMMAND_OUTCOME_TIMEOUT_NS
    + (MAX_COMMAND_ATTEMPTS - 1) * COMMAND_OUTCOME_TIMEOUT_NS
)
...
BOUNDED_WARMUP_MOTION_NS = MAX_STAGE_EXECUTION_NS
...
EXPECTED_STAGE_TIMING_BUDGET = {
    ...
    "extended_sys_state_max_ns": EXTENDED_SYS_STATE_MAX_EXECUTION_NS,
...
def execution_budget_derivation() -> dict[str, Any]:
    ...
    return {
        ...
        "extended_sys_state_maximum_attempts": (
            EXTENDED_SYS_STATE_MAX_COMMAND_ATTEMPTS
        ),
        "extended_sys_state_execution_ns": EXTENDED_SYS_STATE_MAX_EXECUTION_NS,
