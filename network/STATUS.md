...
| P4 Interference and medium access | in_progress | The stock ns-3.40 baseline remains available; separately, a one-UAV MR !2608 spike now proves live ROS pose -> direct Sionna RT Spectrum -> native ALOHA PHY/MAC -> TAP UDP, including LOS/NLOS outcome change and fail-closed stop. | The upstream spike is not connected to five-UAV runtime, has no jammer, and still needs upstream compatibility fixes, dependency pinning and realtime cost measurements. Neither baseline is a technology-specific customer modem model. | Upstream/maintain the two minimal MR !2608 compatibility fixes before considering any five-UAV migration. | `RUN_ID=<unique> network/ns3/run_upstream_sionna_tap_spike.sh` | `runs/upstream-radio-integration/proof_20260831_d/metrics/summary.json` |
